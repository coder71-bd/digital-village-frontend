          ...
          <ul className="space-y-2">
            <li>
              ...
              >
                ...
                <span className="ml-3 text-xl text-bold text-black">
                  Stories in Last
                </span>
              </a>
            </li>
          ...
          <ul className="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3">Learning News</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="ml-3">Medical News</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3">Donation News</span>
              </a>
            </li>
          </ul>
        </div>
